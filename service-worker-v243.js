const CACHE_NAME='muazzin-ka-kaam-v243';
const APP_SHELL=['./index.html','./V243.html','./V242.html','./Muazzin-Ka-Kaam-240-PWA.html','./manifest-v158.webmanifest','./icon-192.svg','./icon-512.svg'];
